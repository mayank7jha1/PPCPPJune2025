...
//Column Wise,Value Wise Sorted
void dfs(TreeNode<int>*root, map<int, multiset<int>>&mp1, int column) {
...
vector<int>VerticalView(TreeNode<int>*root) {
	...
	// map<column_No,multiset of values>mp;
